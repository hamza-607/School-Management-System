        ...
        <form action="{{ route('guardians.update', $theGuardian->id) }}" method="POST" enctype="multipart/form-data" id="studentForm">
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <input class="form-control @error('name') is-invalid @enderror" type="text" name="name" value="{{ $theGuardian->name }}" required>
                    @error('name')
                ...
                <div class="col-md-6">
                    ...
                    <input class="form-control @error('e_name') is-invalid @enderror" type="text" name="e_name" value="{{ $theGuardian->e_name }}">
                    @error('e_name')
                    <div class="invalid-feedback d-block">{{ $message }}</div>
                    @enderror
                </div>
