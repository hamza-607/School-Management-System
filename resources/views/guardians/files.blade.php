...
<h4 class="fw-bold py-3 mb-4">
    <span class="text-muted fw-light">أولياء الأمور /
        ...
        <a href="{{ route('guardians.show', $theGuardian->id) }}" class="text-muted">تفاصيل ولي الأمر {{ $theGuardian->name }}</a> /
    </span> إضافة ملف
</h4>
...
<div class="card mb-4">
    <div class="card-header">
        <h5 class="mb-0">ملفات أولياء الامور</h5>
    </div>
    <div class="card-body">

        <form action="{{ route('guardian.saveFile', $theGuardian->id) }}" method="POST"
