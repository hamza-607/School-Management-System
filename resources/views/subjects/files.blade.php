...
@section('title', 'إضافة ملفات المادة')
...
<h4 class="fw-bold py-3 mb-4">
    <span class="text-muted fw-light">المواد/</span> إضافة ملف لمادة {{ $theSubject->name }}
</h4>
...
<div class="card mb-4">
    <div class="card-header">
        <h5 class="mb-0">ملفات المواد</h5>
    </div>
    <div class="card-body">

        <form action="{{ route('subject.saveFile', $theSubject->id) }}" method="POST"
