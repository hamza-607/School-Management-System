...
<script>
    $(document).ready(function() {
        ...
        $('#gradesPerPage').on('change', function() {

            let perPage = $(this).val();
            let search = $('#gradesSearchInput').val();
...
<h4 class="fw-bold py-3 mb-4">
    <span class="text-muted fw-light">الصفوف /</span> القائمة
</h4>
...
<div class="card">
    <div class="card-header border-bottom d-flex justify-content-between align-items-center">
        <h5 class="card-title mb-0">قائمة الصفوف</h5>
        <div class="d-flex">
...
--}}
            <a href="{{ route('grades.create') }}" class="btn btn-primary">
                <i class="ti ti-plus me-1"></i> إضافة صف جديد
            </a>
        </div>
    </div>
            ...
            <div class="col-md-6">
                <div class="me-3">
                    <label class="d-flex align-items-center selectpicker" data-style="btn-default">عرض
                        <select id="gradesPerPage" class="selectpicker ms-2 me-2" data-style="btn-default" data-width="80px">
            ...
            <div class="col-md-6">
                <div class="d-flex align-items-center justify-content-md-end justify-content-start">
                    <label class="d-flex align-items-center">بحث:
                        <input id="gradesSearchInput" type="search" class="form-control form-control-sm ms-2"
                            placeholder="بحث عن صف..." value="{{ request('search') }}"> </label>
                </div>
            </div>
        </div>
        ...
        <table class="table table-hover border-top">
            <thead>
                <tr>
                    ...
                    <th>الاسم</th>
                    <th class="text-center">عدد الشُعب</th> <!-- أضفنا text-center هنا -->
            ...
            <tbody class="table-border-bottom-0" id="studentTableBody">
                    ...
                    <td class="truncate">
                        <div class="d-flex justify-content-start align-items-center">
                            <div class="d-flex flex-column">
                                <span class="text-body fw-bold text-truncate">{{ $grade->name }}</span>
                            </div>
                        </div>
                    </td>
                    <!-- تعديل عمود عدد الشعب -->
                    <td class="text-center">
                        <a href="{{ route('sections.index', ['grade_id' => $grade->id]) }}" class="badge bg-label-secondary badge-hover-primary px-3">
                ...
                @empty
                <tr>
                    <td colspan="4" class="text-center">لا يوجد صفوف للعرض</td>
                </tr>
                @endforelse
            </tbody>
        </table>
