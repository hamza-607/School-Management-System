...
<div class="card mb-4">
    <div class="card-body">
        <form action="{{ route('staff_members.store', [ 'from' => $from ]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="date_of_birth" id="flatpickr-date" value="{{ old('date_of_birth') }}" class="form-control @error('date_of_birth') is-invalid @enderror" placeholder="YYYY-MM-DD" required>
                ...
                <div class="col-md-6">
                    ...
                    <select id="staffTypeSelect" name="staff_type" class="selectpicker w-100 @error('staff_type') is-invalid @enderror" data-style="btn-default" required>
                        ...
                        <option value="teacher" {{ old('staff_type') == 'teacher' || $from === 'teacher' ? 'selected' : '' }}>معلم</option>
                        <option value="admin" {{ old('staff_type') == 'admin' || $from === 'admin' ? 'selected' : '' }}>إداري</option>
                        <option value="other" {{ old('staff_type') == 'other' || $from === 'other' ? 'selected' : '' }}>أخرى</option>
                    </select>
                ...
                <div class="col-md-6" id="customStaffTypeContainer" style="display: none;">
                    ...
                    <input type="text" id="customStaffTypeInput" name="new_staff_type" value="{{ old('new_staff_type') }}" class="form-control @error('new_staff_type') is-invalid @enderror" placeholder="مثلاً: محاسب، مستخدم...">
                ...
                <div class="col-md-6">
                    ...
                    <input type="file" class="form-control @error('contract_file') is-invalid @enderror" name="contract_file">
                ...
                <div class="col-md-6">
                    ...
                    <input class="form-control @error('salary') is-invalid @enderror" type="number" step="any" name="salary" value="{{ old('salary') }}" placeholder="0.0SP/%">
                    @error('salary')
                ...
                <div class="col-12 mt-3">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="createAccountCheckbox" name="create_account" {{ old('create_account') ? 'checked' : '' }}>
